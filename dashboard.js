...
export async function bindDashboardEvents() {
    ...
    // Cálculos de actividad (semana hábil)
    ...
    if (faltantes <= 0) {
        ...
        textoActividad = `<p style="color: #48484A; font-size: 15px; margin-top: 5px;">Esta semana llevas <strong>${puntosSemana} puntos de 125</strong>. Te hacen falta <strong>${faltantes} puntos</strong> para llegar a la meta.<br><br>🎯 Debes hacer <strong>${ritmo} puntos diarios</strong> en los ${diasRestantes} días hábiles restantes.</p>`;
    }

    // Cálculos de cartera (pendientes del mes)
